...
func TestRequestLineParse(t *testing.T) {
	...
	// Test: Invalid method
	_, err = RequestFromReader(strings.NewReader("ASDF /coffee HTTP/1.1\r\nHost: localhost:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n"))
	require.Error(t, err)
	...
	// Test: Invalid order
	_, err = RequestFromReader(strings.NewReader("/coffee ASDF HTTP/1.1\r\nHost: localhost:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n"))
	require.Error(t, err)
	...
	// Test: Good GET Request line and length 3
	reader := &chunkReader{
		data:            "GET / HTTP/1.1\r\nHost: localhost:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n",
		numBytesPerRead: 3,
	}
	...
	// Test: Good GET Request line with path and length 1
	reader = &chunkReader{
	...
	// Test: Good GET Request line with path and length of string
	data := "GET /coffee HTTP/1.1\r\nHost: localhost:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n"
	reader = &chunkReader{
		data:            data,
	...
	// Test: Empty body empty content-length
	reader = &chunkReader{
		data: "POST /submit HTTP/1.1\r\n" +
			"Host: localhost:42069\r\n" +
			"\r\n",
